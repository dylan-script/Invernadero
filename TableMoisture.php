            ...
            <div class="row">
                <div class="col-10">
                    <div class="data-table table-responsive table-hover table-striped">
                        <table class="table">
                            <caption>Humedad del Sustrato</caption>
                            <thead>
                                <tr>
                                    <th scope="col">Instalación</th>
                                    <th scope="col">Fecha Hora</th>
                                    <th scope="col">Humedad_1</th>
                                    <th scope="col">Humedad_2</th>
                                    <th scope="col">Humedad_3</th>
                                    <th scope="col">Humedad_4</th>
                                    <th scope="col">Humedad_5</th>
                                    <th scope="col">Humedad_6</th>
                                    <th scope="col">Promedio_1_2_3</th>
                                    <th scope="col">Promedio_4_5_6</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr data-toggle="modal" data-target="#opciones">
                                    <th scope="row">1</th>
                                    <td>27/03/2022 19:44:35</td>
                                    <td>24%</td>
                                    <td>0%</td>
                                    <td>42%</td>
                                    <td>76%</td>
