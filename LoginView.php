<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      echo 'Usuario: ' . $myusername . '<br>';
      echo 'Contraseña: ' . $mypassword . '<br>';
      $sql = "SELECT * FROM `users` WHERE id = '$myusername' and pwd = '$mypassword'";
                ...
                <div class="row">
                    <div class="col-10">
                        <form action="login" method="get">
                            ...
                            <input type="text" name="Contraseña" id="Pwd">
                ...
                <div class="row "> 
                    <div class="col-10">
                        <form class="login-form" action="" method="post">
                            ...
                            <input id="login" class="button" type="submit" value="Iniciar Sesión">
                        </form>
                    </div>
                </div>
            </div>
